...
//                         startActivity(uploadPostActivityIntent)
                ...
                // Handle the failure
                Toast.makeText(this, "please fill all the info correctly", Toast.LENGTH_SHORT).show()
    ...
    private fun validate(
        ...
        return isKindValid && isAgeValid && isAgeBiggerThen0 > 0  &&  isAboutValid &&  isPhoneValid
                && isPhoneLongEnough == 10 && isLocationValid && isOwnerValid
    }
    ...
    private fun uploadImage() {
        imageUri?.let {
            val storageReference =
                FirebaseStorage.getInstance().getReference("imagePosts/${System.currentTimeMillis()}.jpg")
